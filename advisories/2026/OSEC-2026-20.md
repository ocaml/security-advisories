...
The security advisory information in that issue is uptodate, and I've just opened cstruct.6.3.0 on the opam-repo with the fixes. Do let me know if I need to do anything else to inform an advisory beyond what I put into the GH issue. I can wait for a CVE, or announce the fix on Discuss first, as you prefer.
