...
severity: "CVSS:3.1/AV:L/AC:L/PR:N/UI:N/S:U/C:N/I:H/A:N"
severity_score: "6.2 (Medium)"
affected: "mirage-crypto-ec" {< "2.2.0"}
events: [
  [
...
credits: [
  ...
  [remediation_developer "Thomas Gazagnaire"]
  [remediation_reviewer "Hannes Mehnert"]
]
cwe: [ CWE-295 ]
affected_bindings: [ "Mirage_crypto_ec.P256.DSA.pub_of_octets" "Mirage_crypto_ec.P384.DSA.pub_of_octets" "Mirage_crypto_ec.P521.DSA.pub_of_octets" ]
```
