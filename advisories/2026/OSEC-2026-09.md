```
id: OSEC-2026-09
modified: "2026-09-23T16:23:50+01:00"
published: "2026-05-28T09:59:44+01:00"
aliases: [ CVE-2026-96609 ]
severity: "CVSS:4.0/AV:N/AC:L/AT:N/PR:L/UI:N/VC:N/VI:N/VA:H/SC:N/SI:N/SA:N/E:U"
severity_score: "4.9 (Medium)"
affected: "albatross" {>= "1.0.0" & < "2.7.2"}
events: [
  [
    git "https://git.robur.coop/robur/albatross.git" [
      [fixed "e07de2a904133e633773302d335ceb1f2c9945da"]
    ]
  ]
]
references: [
  [fix "https://github.com/robur-coop/albatross/pull/273"]
]
credits: [
  [reporter "Reynir Björnsson"]
  [remediation_developer "Reynir Björnsson"]
  [coordinator "Edwin Török"]
]
cwe: [ CWE-770 CWE-405 ]
```
